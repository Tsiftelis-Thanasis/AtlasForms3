...
@Code
    ViewData("Title") = "εγγραφες παιχτων"
End Code
<h2>@ViewBag.Title</h2>
<hr />

@Using (Html.BeginForm("Index", "NewPlayer", FormMethod.Post, New With {.role = "form"}))
...
@Section Scripts
    ...
    $(document).ready(function () {
        ...
        $('#dmdocumentstable').DataTable({
            "sAjaxSource": baseUrl + '@Url.Action("GetNewPlayers")',
            ...
            "columnDefs": [
                    {
                        ...
                        "render": function (data, type, row) {
                            if (row === undefined || row === null) return '';
                                ...
                                var btnEdit = '<a href="@Url.Action("Delete", "Newplayer")/' + row.id + '"><i class="fa fa-pencil-square-o fa-fw"></i>Σβήσιμο της εγγραφής</a>'
                                var btnDetails = '<a href="@Url.Action("Details", "Newplayer")/' + row.id + '"><i class="fa fa-pencil-square-o fa-fw"></i>Προβολή της εγγραφής</a>'
