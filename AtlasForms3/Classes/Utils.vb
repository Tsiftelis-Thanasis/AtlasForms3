...
Public Class Utils
    ...
    Public Sub resizeimages_upd(ByVal originalfilename As String, ByVal destinationfilename As String, ByVal wImage As Integer, ByVal hImage As Integer)

        Using original As Bitmap = Bitmap.FromFile(originalfilename)
            original.SetResolution(72, 72)
            ...
            Params.Param(0) = New EncoderParameter(System.Drawing.Imaging.Encoder.Quality, 98)

            If wImage = 0 Then
                wImage = original.Width
            End If
            If hImage = 0 Then
                hImage = original.Height
            End If

            Using newsizeimage As Image = ResizeImage2(original, New Size(wImage, hImage), True)
                newsizeimage.Save(destinationfilename, Info(1), Params)
            End Using
        End Using
    ...
    Public Function ResizeImage2(ByVal image As Image, ByVal size As Size, Optional ByVal preserveAspectRatio As Boolean = True) As Image
        ...
        Using graphicsHandle As Graphics = Graphics.FromImage(newImage)
            ...
            graphicsHandle.SmoothingMode = Drawing2D.SmoothingMode.HighQuality
    ...
    Public Function Getdiorganwseis() As List(Of Object)
        ...
        Dim kat = (From d In pdb2.DiorganwshTable
                   ...
                   Order By d.Id, d.DiorganwshName
